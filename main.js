...
const main = async function () {
    while (true) {
        ...
        let TotalScore = 10;
        let ObtainedScore = 0;
        const quiz = async (question, choices, rightAnswer) => {
        ...
        await quiz("which is the world's longest river?", [quizAnswer.q1, "Indus River", "Ganga River"], quizAnswer.q1);
        await quiz("what was the profession of Fatima Jinnah ?", ["Lawyer", quizAnswer.q2, , "Teacher"], quizAnswer.q2);
        await quiz("which planet is known as Red Planet ?", ["Mercury", "Earth", quizAnswer.q3], quizAnswer.q3);
        await quiz("Malaria is caused by?", ["Mosquitto", quizAnswer.q4, , "Dengue"], quizAnswer.q4);
        await quiz("who is the last prophet of Allah ?", ["Hazrat Adam (A.s)", "Hazrat Musa (A.s)", quizAnswer.q5], quizAnswer.q5);
